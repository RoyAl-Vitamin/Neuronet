...
public class LSTM {
	...
	private final static boolean NEED_LOAD_NET = false;
	
	private final static String PATH_TO_NET = "MyMultiLayerNetwork.zip";
	...
	public static void main(String[] args) {
		...
		if (NEED_LOAD_NET) { // Load NET
			net = loadNet(new File(PATH_TO_NET));
		} else { // Create NET
			...
			try {
				iter = getShakespeareIterator(miniBatchSize, exampleLength);
			} catch (Exception e) {
			...
			System.out.println("\n\nExample complete");
			saveNet(net, new File(PATH_TO_NET));
		}
	}
	...
	private static void saveNet(MultiLayerNetwork net, File locationToSave) {
		//Save the model
	...
	/** Load the model
	 * @param locationToSave File
	 * @return MultiLayerNetwork
	 */
	private static MultiLayerNetwork loadNet(File locationToSave) {
		try {
